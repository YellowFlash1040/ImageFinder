...
const lightBox = new SimpleLightbox("ul.gallery .image-card", { captionsData: 'alt', captionDelay: 250 });
...
function createImageMarkup(image)
{
    ...
    <a class="image-card" href="${image.largeImageURL}">
        <img src="${image.webformatURL}" alt="${image.tags}" width="360" height="200" style="fit-content: cover"/>
    </a>
